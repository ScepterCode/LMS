...
export default function AddRegistrarPage() {
  ...
  return (
    <DashboardLayout>
      <div className="mb-6">
        <Link href="/dashboard/registrars" className="text-blue-600 hover:text-blue-800 text-sm mb-4 inline-block">
          ← Back to Registrars
        </Link>
        <h2 className="text-2xl font-bold text-gray-900">Add New Registrar</h2>
        <p className="text-gray-600 mt-1">
          Create an account for admissions intake and enrollment records
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6 max-w-2xl">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <h4 className="text-sm font-medium text-blue-900 mb-2">Registrar access</h4>
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Manage student admissions and records</li>
            <li>• Enroll students into classes</li>
            <li>• Manage parent/guardian contact records, including linking parent accounts</li>
            <li>• Does not have access to classes/subjects setup, teachers, grading, or fees</li>
          </ul>
        </div>
        ...
        <div className="flex gap-4 pt-4">
          ...
          >
            {submitting ? 'Creating Account...' : 'Create Registrar Account'}
          </button>
          <Link
